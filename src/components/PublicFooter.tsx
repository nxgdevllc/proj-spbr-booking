        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold">San Pedro Beach Resort</h3>
                <p className="text-sm text-gray-400">Your Perfect Getaway</p>
              </div>
            </div>
            <p className="text-gray-300 text-sm mb-4">
              Experience the perfect blend of comfort and nature at our beachfront resort. 
              Enjoy pristine beaches, modern amenities, and unforgettable memories.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/amenities" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Amenities
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">San Pedro, Laguna</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">+63 912 345 6789</p>
                  <p className="text-gray-300 text-sm">+63 912 345 6790</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <EnvelopeIcon className="h-5 w-5 text-green-400 flex-shrink-0" />
                <div>
                  <p className="text-gray-300 text-sm">info@sanpedrobeachresort.com</p>
                  <p className="text-gray-300 text-sm">reservations@sanpedrobeachresort.com</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">Check-out: 12:00 PM</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} San Pedro Beach Resort. All rights reserved.
            </div>
